...
class TestObserver():
    ...
    obs.notify_observers('message to all observer') # Nachricht muss 3 mal gesendet werden (an 3 Observer)
    obs.remove_observer(3, concrete_observer3)  # Observer 3 wird gelöscht
    obs.notify_observers('message to all observer') # die Nachricht muss 2 mal gesendet werden (2 Observer gibt es noch)
